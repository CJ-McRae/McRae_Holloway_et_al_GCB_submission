...
#Manuscript title:
#A comparison of coral performance in an acute heat-stress assay and a marine heatwave reveals
#a mismatch in bleaching trends


#Authors:
#Crystal J. McRae1*???, Nathaniel Hanna Holloway2???, Guanyan Keelung Chen1,3, Michael T. Connelly4, 
#Hung-Kai Chen1, Zong-Min Ye1, Kendall S. Chancellor2, Yu-Chi Chang1, Ming-Qi Jiang1, Kwok Wai Lam1, 
#Yu-Ting Qiu1, Tung-Yung Fan1,5*, Stuart A. Sandin2
...
#4 Department of Invertebrate Zoology, Smithsonian Institution, Washington, DC, United States of America, 20560.
