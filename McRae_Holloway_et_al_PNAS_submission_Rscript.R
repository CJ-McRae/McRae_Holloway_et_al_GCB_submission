...
#Manuscript title:
#Do lab assessments of coral thermal tolerance match in situ performance during marine heatwaves? 
#A heat-stress assay and large-area imaging comparison

#Authors:
#Crystal J. McRae1*, Nathaniel H. Holloway2, Guanyan Keelung Chen1,3, Zong-Min Ye1, Hung-Kai Chen1, 
#Kendall Chancellor2, Michael T. Connelly4, Yu-Chi Chang1, Ming-Qi Jiang1, Kwok Wai Lam1, Yu-Ting Qiu1, 
#Tung-Yung Fan1,5*, Stuart A. Sandin2


#Affiliations:
#1 Department of Research and Planning, National Museum of Marine Biology and Aquarium, Pingtung, Taiwan, 944401.
#2 Center for Marine Biodiversity and Conservation, Scripps Institution of Oceanography, La Jolla, California, United States of America, 92093.
#3 Hawaii Institute of Marine Biology, University of Hawaii, Honolulu, Hawaii, United States of America, 96822.
#4 Department of Invertebrate Zoology, Smithsonian Institution, Washington, DC, United States of America, 20024.
#5 Department of Marine Biotechnology and Resources, National Sun Yat-sen University, Kaohsiung, Taiwan, 804201. 

#Crystal J. McRae and Nathaniel H. Holloway contributed equally
#Corresponding authors: Tung-Yung Fan and Crystal J. McRae

#Contact Information: 
#Address: No. 2, Houwan Road, Houwan Village, Checheng Township, Pingtung County, Taiwan 944401.
#Phone: 886-08-8825001 ext. 2248
#Email: tyfan@nmmba.gov.tw (TYF); crystal.j.mcrae@gmail.com (CJM) 
...
raw_DHW_COMBO_PLOT <- raw_temp_combo_plot | DHW_combo
raw_DHW_COMBO_PLOT
...
#Evensen NR, Voolstra CR, Fine M, Perna G, Buitrago-López C, Cárdenas A, Banc-Prandi G, Rowe K, Barshis DJ.
...
####mixed model assesment of Fv/Fm post experiment
...
#it means that a previously loaded package is interferring 
